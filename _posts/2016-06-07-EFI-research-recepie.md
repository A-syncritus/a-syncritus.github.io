...
Hoppefully this helps vendors understand the issues they are facing (encrypt your binaries!), and gives security expects a couple of hints (EFI reversing is simple).
